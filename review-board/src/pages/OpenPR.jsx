...
export default function OpenPR() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-6 bg-white rounded-3xl p-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-gray-500">Last updated: {prs.length ? formatDate(prs[0]?.updated_at) : 'Not loaded'}</div>
            </div>
          </div>
        </header>
                ...
                <tbody className="bg-white divide-y">
                  {prs.map((pr) => (
                    <tr key={pr.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm">{formatDate(pr.updated_at)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <footer className="mt-6 text-center text-sm text-gray-500">Made with ♥ — OpenPR viewer</footer>
      </div>
    </div>
  );
}
